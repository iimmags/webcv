        ...
        {experience.map((job) => (
          ...
          >
            <Heading>
              <Button
                slot="trigger"
                className="flex w-full items-center justify-between gap-4 rounded-xl px-5 py-4 text-left transition hover:bg-slate-50 data-[focus-visible]:ring-2 data-[focus-visible]:ring-slate-900"
              >
